...
<div class="main-container">
    <div class="profile-header">
        <h1><?php echo e($portfolio->title ?? 'Моё портфолио'); ?></h1>
        <p class="name">Пользователь: <strong><?php echo e(auth()->user()->name); ?></strong></p>
    </div>
...
<?php if(auth()->user()->isAdmin()): ?>
    <?php echo $__env->make('admin-users', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\test-demo\resources\views/profile.blade.php ENDPATH**/ ?>